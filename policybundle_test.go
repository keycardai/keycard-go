...
func TestPolicyBundleGetWithOptionalParams(t *testing.T) {
	...
	resp, err := client.PolicyBundle.Get(context.TODO(), keycard.PolicyBundleGetParams{
		IfNoneMatch:      keycard.String("If-None-Match"),
...
func TestPolicyBundleUpdateWithOptionalParams(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(200)
		w.Write([]byte("abc"))
	}))
...
func TestPolicyBundleResetWithOptionalParams(t *testing.T) {
