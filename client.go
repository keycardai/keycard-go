...
// KEYCARD_API_USERNAME, KEYCARD_API_PASSWORD, KEYCARD_API_BASE_URL). This should
...
func DefaultClientOptions() []option.RequestOption {
	...
	if o, ok := os.LookupEnv("KEYCARD_API_USERNAME"); ok {
		defaults = append(defaults, option.WithUsername(o))
	}
	if o, ok := os.LookupEnv("KEYCARD_API_PASSWORD"); ok {
...
// environment (KEYCARD_API_API_KEY, KEYCARD_API_USERNAME, KEYCARD_API_PASSWORD,
// KEYCARD_API_BASE_URL). The option passed in as arguments are applied after these
